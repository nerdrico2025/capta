...
const SOURCE = 'ESCOLA_ABERTA_3SETOR';
const PAGE_URL = 'https://escolaaberta3setor.org.br/categoria/editais/';
...
function extractBlocks(html: string): Array<{ html: string; url: string | null }> {
  ...
  const selectors = ['article', '.post', '[class*="card"]', 'h2 a'];
...
export class EscolaAberta3SetorCollector {
