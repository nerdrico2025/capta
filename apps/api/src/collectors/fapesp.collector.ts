...
const SOURCE = 'FAPESP';
const PAGE_URL = 'https://fapesp.br/chamadas/';
const UA = 'Mozilla/5.0 (compatible; CaptaBot/1.0; +https://capta.org.br)';

// FAPESP foca em pesquisa científica — filtrar apenas chamadas relevantes para OSCs
const OSC_FILTER =
...
function extractBlocks(html: string): string[] {
  ...
  const selectors = ['li', '[class*="chamada"]', '[class*="item"]', '[class*="card"]', 'article'];
